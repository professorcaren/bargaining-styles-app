...
const STYLE_PROFILES = {
  Competing: {
    ...
    long: [
      ...
      "This can be an advantage in transactional bargaining, but it can also be hard on relationships and can focus attention too narrowly on issues that are easiest to count as wins and losses.",
  ...
  Collaborating: {
    ...
    long: [
      ...
      "This can be a major strength, but high collaborators can also overcomplicate simple situations and may need stronger claiming skills to hold their own against a very competitive counterpart.",
  ...
  Compromising: {
    ...
    long: [
      ...
      "High compromisers are often seen as reasonable, but they can rush the process, make concessions too quickly, and settle on the first fair standard before testing whether a better deal is available.",
  ...
  Avoiding: {
    ...
    long: [
      ...
      "That can be a real strength in some settings, but high avoiders can also let important conflicts fester and may pass up opportunities to ask for things that others would willingly grant.",
  ...
  Accommodating: {
    ...
    long: [
      ...
      "This is a genuine strength in team settings, service roles, and relationship management, but high accommodators can overweight the relationship and become vulnerable to more competitive counterparts.",
